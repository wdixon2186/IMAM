...
def script_list(request):
    ...
    return render(request, 'inter/script_list.html', {'scripts': scripts})
...
def script_create(request):
    if request.method == 'POST':
        ...
        form = ScriptForm()
    return render(request, 'inter/script_form.html', {'form': form})
...
def showvideo(request):
    ...
    return render(request, 'inter/video_list.html', context)

def video_list(request):
    videos = Video.objects.all()
    print(videos)
    return render(request, 'inter/video_list.html', {'videos': videos})
...
def video_create(request):
    if request.method == 'POST':
        ...
        form = VideoForm()
    return render(request, 'inter/video_form.html', {'form': form})
...
def video_detail(request, pk):
    ...
    return render(request, 'inter/video_detail.html', {'video': video})

def comment_list(request):
    comments = Comment.objects.all()
    return render(request, 'inter/comment_list.html', {'comments': comments})
...
def comment_create(request):
    if request.method == 'POST':
        ...
        form = CommentForm()
    return render(request, 'inter/comment_form.html', {'form': form})
...
def about(request):
    return render(request, 'inter/about.html')
...
def script_detail(request, pk):
    ...
    if script.likes.filter(id=request.user.id).exists():
        is_liked = True
    return render(request, 'inter/script_detail.html', {'script': script, 'total_likes': script.total_likes()})